...
const Contact = () => {
  return (
    <section id ="contact" className="  min-h-screen py-12 px-4 sm:px-8 md:px-20 lg:px-32 flex flex-col items-center justify-center">
      ...
      <div className="w-full flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 md:gap-12 flex-wrap">
        ...
        />
        <ContactDesign
          href="https://www.instagram.com/contanto.studio/"
          label="Instagram"
          color="pink"

        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div className="hidden flex-col gap-2 text-xl font-bold
               md:flex md:text-4xl md:pl-20 text-neutral-300">
                    <h3>{item.date}</h3>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <div className="block mb-4 text-2xl md:hidden text-neutral-300">
               <h3>{item.date}</h3>
              <h3>{item.job}</h3>
              </div>
              {item.contents.map((content,index)=>(<p key={index} className="mb-3 text-neutral-400 font-normal">
               {content}
              </p>))}
